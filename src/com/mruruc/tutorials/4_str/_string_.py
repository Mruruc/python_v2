...
## Sorting Strings
# Strings can be sorted alphabetically or in reverse alphabetical order using the built-in sorted() function
# my_string = "hello"
# sorted_string = sorted(my_string)
# print(sorted_string)  # Output: ['e', 'h', 'l', 'l', 'o']
# reverse_sorted_string = sorted(my_string, reverse=True)
# print(reverse_sorted_string)  # Output: ['o', 'l', 'l', 'h', 'e']
